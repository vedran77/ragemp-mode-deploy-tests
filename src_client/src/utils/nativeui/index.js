!(function (e) {
	...
	function (e, t, s) {
		...
		(a.Empty = new a(0, 0, 0, 0)),
			(a.Transparent = new a(0, 0, 0, 0)),
			(a.Black = new a(0, 0, 0, 255)),
			(a.White = new a(255, 255, 255, 255)),
			(a.WhiteSmoke = new a(245, 245, 245, 255));
		class l {
			...
			Draw(e, t, s, i, n, h, o) {
				...
				const r =
						1080 *
						(mp.game.resolution.width / mp.game.resolution.height),
					a = this.size.Width / r,
					l = this.size.Height / 1080,
					c = this.pos.X / r + 0.5 * a,
					u = this.pos.Y / 1080 + 0.5 * l;
		...
		class _ extends d {
			constructor(e, t, s, i, n, h) {
				super(),
					...
					(this.pos = t),
					(this.scale = s),
					(this.color = i || new a(255, 255, 255, 255)),
					(this.font = n || 0),
					(this.centered = h || !1);
			}
			Draw(e, t, s, i, n, h) {
				!e ||
					...
					n ||
					h ||
					((t = new u(this.pos.X + e.Width, this.pos.Y + e.Height)),
					(s = this.scale),
					(i = this.color),
					(n = this.font),
					(h = this.centered));
		...
		class p extends _ {
			constructor(e, t, s, i, n, h) {
				super(e, t, s, i || new a(255, 255, 255), n || 0, !1),
					(this.TextAlignment = o.Left),
			...
			Draw(e, t, s, i, n, h, r, a, l) {
				...
				if (
					...
					mp.game.ui.setTextCentre(d);
				else {
					switch (
						(r && mp.game.ui.setTextDropshadow(2, 0, 0, 0, 0),
						a && console.warn('not working!'),
						g)
					) {
						case o.Centered:
		...
		class I {
			constructor(e, t = '') {
				(this.BackColor = I.DefaultBackColor),
					(this.HighlightedBackColor = I.DefaultHighlightedBackColor),
					(this.ForeColor = I.DefaultForeColor),
					(this.HighlightedForeColor = I.DefaultHighlightedForeColor),
					(this.RightLabel = ''),
					(this.LeftBadge = h.None),
					(this.RightBadge = h.None),
					(this.Enabled = !0),
					(this._rectangle = new f(
						new u(0, 0),
						new m(431, 38),
						new a(150, 0, 0, 0)
					)),
					...
					(this.Description = t),
					(this._selectedSprite = new l(
						'commonmenu',
						'gradient_nav',
						new u(0, 0),
						new m(431, 38)
					)),
					(this._badgeLeft = new l(
						'commonmenu',
						'',
						new u(0, 0),
						new m(40, 40)
					)),
					(this._badgeRight = new l(
						'commonmenu',
						'',
						new u(0, 0),
						new m(40, 40)
					)),
					(this._labelText = new p(
						'',
						new u(0, 0),
						0.35,
						a.White,
			...
			SetVerticalPosition(e) {
				(this._rectangle.pos = new u(
					this.Offset.X,
					e + 144 + this.Offset.Y
				)),
					(this._selectedSprite.pos = new u(
						0 + this.Offset.X,
						e + 144 + this.Offset.Y
					)),
					(this._text.pos = new u(
						8 + this.Offset.X,
						e + 147 + this.Offset.Y
					)),
					(this._badgeLeft.pos = new u(
						0 + this.Offset.X,
						e + 142 + this.Offset.Y
					)),
					(this._badgeRight.pos = new u(
						385 + this.Offset.X,
						e + 142 + this.Offset.Y
					)),
					(this._labelText.pos = new u(
						420 + this.Offset.X,
						e + 148 + this.Offset.Y
					));
			}
			...
			Draw() {
				(this._rectangle.size = new m(
					431 + this.Parent.WidthOffset,
					38
				)),
					(this._selectedSprite.size = new m(
						431 + this.Parent.WidthOffset,
						38
					)),
					this.Hovered &&
						!this.Selected &&
						((this._rectangle.color = new a(255, 255, 255, 20)),
			...
			BadgeToColor(e, t) {
				switch (e) {
					...
					case h.Crown:
						return t
							? new a(255, 0, 0, 0)
							: new a(255, 255, 255, 255);
					default:
						return new a(255, 255, 255, 255);
				}
			}
		}
		(I.DefaultBackColor = a.Empty),
			(I.DefaultHighlightedBackColor = a.White),
			(I.DefaultForeColor = a.WhiteSmoke),
			(I.DefaultHighlightedForeColor = a.Black);
		class w extends I {
			constructor(e, t = !1, s = '') {
				super(e, s),
					(this.OnCheckedChanged = new c()),
					(this.Checked = !1);
				(this._checkedSprite = new l(
					'commonmenu',
					'shop_box_blank',
					new u(410, 95),
					new m(50, 50)
		...
		class S {
			...
			getListItems() {
				...
				for (const t of this.items)
					t instanceof x
						? e.push(t)
						: 'string' == typeof t && e.push(new x(t.toString()));
				return e;
			}
		}
		class C {
		...
		class M extends I {
			constructor(e, t = '', s = new S([]), i = 0) {
				super(e, t),
					...
					(this.OnListChanged = new c()),
					(this._index = 0);
				(this.Collection = s.getListItems()),
					(this.Index = i),
					(this._arrowLeft = new l(
						'commonmenu',
						'arrowleft',
						new u(110, 105),
						new m(30, 30)
					)),
					(this._arrowRight = new l(
						'commonmenu',
						'arrowright',
						new u(280, 105),
						new m(30, 30)
					)),
					(this._itemText = new p(
						'',
						new u(290, 104),
						0.35,
						a.White,
		...
		class O extends I {
			...
			constructor(e, t, s, i = '', n = !1) {
				...
				(this._items = t),
					...
					(this._rectangleBackground = new f(
						new u(0, 0),
						new m(150, 9),
						new a(4, 32, 57, 255)
					)),
					(this._rectangleSlider = new f(
						new u(0, 0),
						new m(75, 9),
						new a(57, 116, 200, 255)
					)),
					(this._rectangleDivider = new f(
						new u(0, 0),
						new m(2.5, 20),
						n ? a.WhiteSmoke : a.Transparent
					)),
					(this.Index = s);
			}
			SetVerticalPosition(e) {
				(this._rectangleBackground.pos = new u(
					250 + this.Offset.X + this.Parent.WidthOffset,
					e + 158.5 + this.Offset.Y
				)),
					(this._rectangleSlider.pos = new u(
						250 + this.Offset.X + this.Parent.WidthOffset,
						e + 158.5 + this.Offset.Y
					)),
					(this._rectangleDivider.pos = new u(
		...
		class D extends g {
			...
			Draw(e) {
				...
				const t =
					...
					n = (this.pos.X + e.Width) / t + 0.5 * s,
					h = (this.pos.Y + e.Height) / 1080 + 0.5 * i;
				...
				this.Items))
					o.Draw(new m(this.pos.X + e.Width, this.pos.Y + e.Height));
			}
		}
		class R {
		...
		(mp.game.resolution = {}),
			(mp.game.resolution.width = b.x),
			(mp.game.resolution.height = b.y);
		class T {
			constructor(e, t, s, i, n) {
				(this.counterPretext = ''),
					...
					(this.MenuItems = []),
					(this.onIndexChange = new c()),
					(this.onListChange = new c()),
					(this.onSliderChange = new c()),
					(this.onSliderSelect = new c()),
					(this.onCheckboxChange = new c()),
					(this.onItemSelect = new c()),
					(this.onMenuClose = new c()),
					(this.onMenuChange = new c()),
					(this.MouseEdgeEnabled = !0),
					s instanceof u || (s = u.Parse(s)),
					(this.title = e),
					(this.subtitle = t),
					(this.spriteLibrary = i || 'commonmenu'),
					(this.spriteName = n || 'interaction_bgd'),
					(this.offset = new u(s.X, s.Y)),
					(this.Children = new Map()),
					(this._mainMenu = new D(
						new u(0, 0),
						new m(700, 500),
						new a(0, 0, 0, 0)
					)),
					(this._logo = new l(
						this.spriteLibrary,
						this.spriteName,
						new u(0 + this.offset.X, 0 + this.offset.Y),
						new m(431, 107)
					)),
					this._mainMenu.addItem(
						(this._title = new p(
							this.title,
							new u(215 + this.offset.X, 20 + this.offset.Y),
							1.15,
							new a(255, 255, 255),
							1,
							o.Centered
					...
					'' !== this.subtitle &&
						(this._mainMenu.addItem(
							new f(
								new u(0 + this.offset.X, 107 + this.offset.Y),
								new m(431, 37),
								new a(0, 0, 0, 255)
							)
						),
						this._mainMenu.addItem(
							(this._subtitle = new p(
								this.subtitle,
								new u(8 + this.offset.X, 110 + this.offset.Y),
								0.35,
								new a(255, 255, 255),
								0,
								o.Left
						...
						(this._counterText = new p(
							'',
							new u(425 + this.offset.X, 110 + this.offset.Y),
							0.35,
							new a(255, 255, 255),
							0,
							o.Right
					...
					(this._extraRectangleDown = new f(
						new u(
							0 + this.offset.X,
							162 +
								38 * (this.MaxItemsOnScreen + 1) +
					...
					(this._descriptionBar = new f(
						new u(this.offset.X, 123),
						new m(431, 4),
						a.Black
					)),
					(this._descriptionRectangle = new l(
						'commonmenu',
						'gradient_bgd',
						new u(this.offset.X, 127),
						new m(431, 30)
					)),
					(this._descriptionText = new p(
						'Description',
						new u(this.offset.X + 5, 125),
						0.35,
						new a(255, 255, 255, 255),
						r.ChaletLondon,
						o.Left
					)),
					(this._background = new l(
						'commonmenu',
						'gradient_bgd',
						new u(
							this.offset.X,
			...
			RecalculateDescriptionPosition() {
				(this._descriptionBar.pos = new u(
					this.offset.X,
					112 + this.extraOffset + this.offset.Y
				)),
					(this._descriptionRectangle.pos = new u(
						this.offset.X,
						112 + this.extraOffset + this.offset.Y
					)),
					(this._descriptionText.pos = new u(
						this.offset.X + 8,
						118 + this.extraOffset + this.offset.Y
					)),
					(this._descriptionBar.size = new m(
						431 + this.WidthOffset,
						4
					)),
					(this._descriptionRectangle.size = new m(
						431 + this.WidthOffset,
						30
					));
			...
			SetMenuWidthOffset(e) {
				if (
					((this.WidthOffset = e),
					null != this._logo &&
						(this._logo.size = new m(431 + this.WidthOffset, 107)),
					(this._mainMenu.Items[0].pos = new u(
						(this.WidthOffset + this.offset.X + 431) / 2,
						20 + this.offset.Y
					)),
					this._counterText &&
						(this._counterText.pos = new u(
							425 + this.offset.X + e,
							110 + this.offset.Y
						)),
					this._mainMenu.Items.length >= 2)
				) {
					this._mainMenu.Items[1].size = new m(
						431 + this.WidthOffset,
						37
					);
				}
			...
			Open() {
				R.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY),
					(this.Visible = !0);
			}
			Close() {
				R.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY),
			...
			GoLeft() {
				if (
					this.MenuItems[this.CurrentSelection] instanceof M ||
					this.MenuItems[this.CurrentSelection] instanceof O
				)
					if (this.MenuItems[this.CurrentSelection] instanceof M) {
						...
						e.Index--,
							...
							this.onListChange.emit(e, e.Index);
					} else if (
						this.MenuItems[this.CurrentSelection] instanceof O
					) {
						const e = this.MenuItems[this.CurrentSelection];
			...
			SelectItem() {
				if (!this.MenuItems[this.CurrentSelection].Enabled)
					return void R.PlaySound(
						this.AUDIO_ERROR,
						this.AUDIO_LIBRARY
					);
				const e = this.MenuItems[this.CurrentSelection];
				if (this.MenuItems[this.CurrentSelection] instanceof w)
					(e.Checked = !e.Checked),
						R.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY),
						this.onCheckboxChange.emit(e, e.Checked);
				else if (
					(R.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY),
					this.onItemSelect.emit(e, this.CurrentSelection),
					this.Children.has(e))
				) {
					const t = this.Children.get(e);
					(this.Visible = !1),
						(t.Visible = !0),
						this.onMenuChange.emit(t, !0);
				}
				e.fireEvent();
			}
			...
			IsMouseInListItemArrows(e, t, s) {
				...
				const h =
						...
						10,
					o = 431 - h;
				return this.IsMouseInBounds(t, new m(h, 38))
					? 1
					: this.IsMouseInBounds(new u(t.X + h, t.Y), new m(o, 38))
					? 2
					: 0;
			}
			ProcessMouse() {
				...
				this.MenuItems.length > this.MaxItemsOnScreen + 1 &&
					(e = this._maxItem),
					this.IsMouseInBounds(new u(0, 0), new m(30, 1080)) &&
				...
				this.MenuItems.length <= this.MaxItemsOnScreen + 1 ||
					(this.IsMouseInBounds(
						new u(n, i),
						new m(431 + this.WidthOffset, 18)
					)
						? ((this._extraRectangleUp.color = new a(
								30,
								30,
								30,
								255
						  ...
						  (mp.game.controls.isControlJustPressed(0, 24) ||
								...
								this.MaxItemsOnScreen + 1
									? this.GoUpOverflow()
									: this.GoUp()))
						: (this._extraRectangleUp.color = new a(0, 0, 0, 200)),
					this.IsMouseInBounds(
						new u(n, i + 18),
						new m(431 + this.WidthOffset, 18)
					)
						? ((this._extraRectangleDown.color = new a(
								30,
								30,
								30,
								255
						  ...
						  0 != this.MenuItems.length &&
								...
								this.lastUpDownNavigation + 120 < Date.now()
									...
									: mp.game.controls.isControlPressed(
									  ...
									  this.lastLeftRightNavigation + 100 <
											Date.now()
									? ((this.lastLeftRightNavigation =
											Date.now()),
									  this.GoLeft())
									: mp.game.controls.isControlJustReleased(
											0,
			...
			GoUpOverflow() {
				this.MenuItems.length <= this.MaxItemsOnScreen + 1 ||
					...
					R.PlaySound(this.AUDIO_UPDOWN, this.AUDIO_LIBRARY),
			...
			GoBack() {
				R.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY),
					...
					null != this.ParentMenu &&
						...
						this.onMenuChange.emit(this.ParentMenu, !1)),
					this.onMenuClose.emit();
			}
			BindMenuToItem(e, t) {
				(e.ParentMenu = this),
				...
				if (this.Visible) {
					...
					if (this.MenuItems.length <= this.MaxItemsOnScreen + 1) {
						...
						for (const t of this.MenuItems)
							t.SetVerticalPosition(
								38 * e - 37 + this.extraOffset
							),
								t.Draw(),
								e++;
						this._counterText &&
						...
						for (let s = this._minItem; s <= this._maxItem; s++) {
							...
							e.SetVerticalPosition(
								38 * t - 37 + this.extraOffset
							),
								e.Draw(),
								t++;
						}
						if (
							((this._extraRectangleUp.size = new m(
								431 + this.WidthOffset,
								18
							)),
							(this._extraRectangleDown.size = new m(
								431 + this.WidthOffset,
								18
							)),
							(this._upAndDownSprite.pos = new u(
		...
		(exports.Menu = T),
			(exports.UIMenuItem = I),
			(exports.UIMenuListItem = M),
			(exports.UIMenuCheckboxItem = w),
			(exports.UIMenuSliderItem = O),
			(exports.BadgeStyle = h),
			(exports.Point = u),
			(exports.Size = m),
			(exports.Color = a),
			(exports.Font = r),
			(exports.ItemsCollection = S),
			(exports.ListItem = x);
	},
]);
