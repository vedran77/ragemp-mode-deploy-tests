  ...
  render() {
    ...
    return (
      <div className='vehicle-dump'>
        <PrimaryTitle className='vehicle-dump_title'>
          Prodaja vozila
        </PrimaryTitle>
        ...
        <div className='vehicle-dump_container'>
          <div className='vehicle-dump_info'>
            <div className='vehicle-dump_info-item'>
              Marka i model: <b>{(vehicleList as any)[model] || model}</b>
            </div>
          </div>

          <TotalPrice
            className='vehicle-dump_price'
            title='Zarada:'
            value={price}
          />
        </div>
        ...
        <div className='vehicle-dump_footer'>
          <OutlineButton isClose>Odustani</OutlineButton>
