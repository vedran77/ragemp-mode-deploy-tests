	...
	render() {
		...
		return (
			<div className="weapons_ammo">
				<PrimaryTitle className="weapons_ammo-title">Municija</PrimaryTitle>
				...
				<div className="weapons_ammo-amount">
					<h4 className="title">Količina</h4>

					<OutlineInput value={amount} max={1000} min={0} onChange={this.setAmount.bind(this)} />
				</div>
