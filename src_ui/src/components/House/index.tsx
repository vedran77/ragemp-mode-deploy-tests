...
export default class House extends Component<Props, State> {
  ...
  async trade() {
    ...
    try {
      ...
      showNotification(
        ...
        isOwner
          ? 'Uspešna prodaja!'
          : 'Čestitamo na kupovini! Da biste platili usluge, idite u banku.'
      );
  ...
  async toggleLock() {
    try {
      ...
      showNotification('error', 'Nije dostupno!');
  ...
  async toEnter() {
    try {
      ...
      showNotification('error', 'Vrata su zaključana!');
    }
  }
      ...
      <div className='house'>
        <div className='house_container'>
          ...
          <div className='house_buttons'>
            ...
            <OutlineButton isClose>Otkaži</OutlineButton>
