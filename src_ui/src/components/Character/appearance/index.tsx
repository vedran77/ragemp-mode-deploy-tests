...
const maleOptions = { ...options, beard: 'Brada' };
const femaleOptions = { ...options, makeup: 'Šminka' };
    ...
    switch (activeOption) {
      ...
      case 'face':
        return (
          <Face
            values={headOverlay}
            update={this.changeHeadOverlay.bind(this)}
          />
        );
      case 'beard':
        return (
